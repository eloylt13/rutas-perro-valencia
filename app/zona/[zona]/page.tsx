...
import { getRutasByZona, getZonaBySlug, getZonaSlug, getZonas } from "@/lib/rutas";
...
export async function generateMetadata({
  ...
  return {
    title: `Rutas en ${zona}`,
    description: `Listado de rutas con perro en ${zona}.`
  };
}
  ...
  return (
    <div className="space-y-6">
      <section className="panel px-6 py-8 sm:px-8">
        ...
        <h2 className="mt-2 text-3xl font-bold text-bosque">{zona}</h2>
